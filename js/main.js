(function () {
  ...
  function productCard(product) {
    ...
    const detailHref = `product-detail.html?id=${encodeURIComponent(product.code)}&v=20260515-color-image-fit`;
    return `
  ...
  function renderProductDetail() {
    ...
    if (!product) {
      mount.innerHTML = `<div class="page-hero"><h1>PRODUCT NOT FOUND</h1><p>제품 데이터를 찾을 수 없습니다.</p><a class="btn btn-dark" href="products.html?v=20260515-color-image-fit">Back to Products</a></div>`;
      return;
    }
    ...
    mount.innerHTML = `
      <div class="detail-grid">
        ...
        <aside class="detail-summary">
          ...
          <a class="btn btn-dark full" href="contact.html?v=20260515-color-image-fit&product=${encodeURIComponent(product.name)}">Wholesale Inquiry</a>
        </aside>
      </div>
